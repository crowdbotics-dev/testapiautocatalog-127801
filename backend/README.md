...
## Project Structure
    ...
    ├── testapiautocatalog_127801  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_127801`
...
2. Clone this repo and `cd testapiautocatalog_127801`
